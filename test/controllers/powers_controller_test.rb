...
class PowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create power" do
    assert_difference("Power.count") do
      post powers_url, params: { power: { category: @power.category, damage_points: @power.damage_points, description: @power.description, name: @power.name, race_id: @power.race_id } }
    end
  ...
  test "should update power" do
    patch power_url(@power), params: { power: { category: @power.category, damage_points: @power.damage_points, description: @power.description, name: @power.name, race_id: @power.race_id } }
